...
#### LOGO ####
logo = """
\033[1;98m   _____ _   _ __  __ ___ ____   ___
                         |_   _| | | |  \/  |_ _/ ___| / _ \
                           | | | | | | |\/| || |\___ \| | | |     ♻
                           | | | |_| | |  | || | ___) | |_| |     ♻
...
print  """
\033[1;97m************************************************
\033[1;96m~ IM NOT RESPONSIBLE FOR ANY MISS USE DR TUMISO RSA~
\033[1;97m************************************************
 
\033[1;95m____─▄───────▄█▄───────▄─ Stay Home 💓
\033[1;95m____▐█▌──▄──█████──▄──▐█▌ Stay Safe 💓
\033[1;95m____─█──███▄▄███▄▄███──█─ Care Yourslef💓
\033[1;95m____BEATER FEAR TUMISO RETURN
\033[1;95m____██▄▄█▄█▄█▒▒▒█▄█▄█▄▄██ 
"""
jalan("\033[1;92m              _    _     _ ")             
jalan("\033[1;92m             | |  (_)   | |")             
jalan("\033[1;92m  _ __   __ _| | ___ ___| |_ __ _ _ __  TumisoRSA✔") 
...
CorrectUsername = "Trazim"
CorrectPassword = "Tiepecy"
loop = 'true'
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open t.me/TumisoRSA')
    else:
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•══════•◈•\033[1;91mTumispRsar\033[1;97m•◈•══════•◈•"
	...
	jalan('           \033[1;91mTumiso start cloning Wait...')
	print  "  \033[1;92m ●══════════════════◄►══════════════════●" 
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;91mTrazimTiepecy[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed By TumisoRSA--•◈•---»" #Dev:Rana
	print '\033[1;93m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 trazim.py)↩\033[1;97m....'
...
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;91m ....Savage RSA....... \033[1;95m :
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                Facebook
              \033[1;91m Trazim"""
